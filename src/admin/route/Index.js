...
import SelectedCarList from "../pages/jumo/selectedcar/Index";
import PurchaseHistory from "../pages/jumo/purchasehistory/Index";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
       ...
       {/*Jumo Pages*/}
       <Route exact path={`${process.env.PUBLIC_URL}/selected-cars`} component={SelectedCarList}></Route>

       <Route exact path={`${process.env.PUBLIC_URL}/purchase-history`} component={PurchaseHistory}></Route>
